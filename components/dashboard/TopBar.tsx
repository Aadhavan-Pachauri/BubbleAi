...
export const TopBar: React.FC<TopBarProps> = ({ 
  ...
  return (
    <header className={`relative z-20 flex-shrink-0 h-16 flex items-center justify-between px-4 md:px-8 border-b ${showAurora ? 'bg-transparent border-transparent' : 'bg-bg-primary border-border-color'}`}>
