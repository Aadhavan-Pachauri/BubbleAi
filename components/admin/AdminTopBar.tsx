...
export const AdminTopBar: React.FC<AdminTopBarProps> = ({ 
  ...
  if (workspaceMode === 'autonomous') {
    return (
      <header className={`relative flex-shrink-0 h-16 flex items-center justify-between md:justify-center px-4 md:px-8 border-b ${showAurora ? 'bg-transparent border-transparent' : 'bg-bg-primary border-border-color'}`}>
  ...
  return (
    <header className={`relative flex-shrink-0 h-16 flex items-center justify-between px-4 md:px-8 border-b ${showAurora ? 'bg-transparent border-transparent' : 'bg-bg-primary border-border-color'}`}>
