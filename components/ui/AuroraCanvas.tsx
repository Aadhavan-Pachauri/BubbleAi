...
// A robust and theme-appropriate implementation of the user's provided WebGL aurora effect.
export default function AuroraCanvas() {
  ...
  useEffect(() => {
    ...
    try {
        ...
        console.warn("WebGL is not supported by this browser. The aurora background will not be displayed.");
        return;
    }
    ...
    const setup = () => {
        ...
        const fragmentShaderSrc = `
          ...
          void main() {
              ...
              vec3 color1 = vec3(0.6, 0.3, 0.8); // Lilac
              vec3 color2 = vec3(0.2, 0.4, 0.9); // Blue
              vec3 color3 = vec3(0.1, 0.6, 0.7); // Teal

              float noise1 = fbm(uv * 2.0 + time * 0.2);
              float noise2 = fbm(uv * 1.5 - time * 0.15);
              
              vec3 finalColor = vec3(0.05, 0.05, 0.1); // Dark navy base
